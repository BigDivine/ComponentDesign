        ...
        for (int i = 0; i < mPieModelList.size(); i++) {
            if (mPieModelList.get(i).percent > 0) {
                if (mAnimaAngle >= mPieModelList.get(i).startAngle &&
                    ...
                    Log.e("dinglpaaaa", mPieModelList.get(i).startAngle+"");
                    Log.e("dinglpaaaaw", mAnimaAngle - mPieModelList.get(i).startAngle+"");
                    ...
                    Log.e("dinglpaaaa", mPieModelList.get(i).startAngle+"");
                    Log.e("dinglpaaaaw", mAnimaAngle - mPieModelList.get(i).sweepAngle+"");
                }
